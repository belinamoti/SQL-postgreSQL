...
-- A: I would use 3 tables employees table, a categories table and employees_categories table that establishes many to many relationship between employees and categories tables.
